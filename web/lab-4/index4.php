...
function addEntryToGoogleSheet($title, $text, $category)
{
    ...
    $spreadsheetId = '1TXxvEJfCZ-M8Ay8-yoSDbs-Urov5NBZTFenRjl1M23U/edit#gid=0';
...
addEntryToGoogleSheet($title, $text, $category);